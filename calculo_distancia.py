...
def geocoding(location, key):
    while location == "": 
        ...
        while True: 
            ...
            vehicle = input("Cómo viajará?: ") 

            if vehicle == "salir" or vehicle == "s": 
                break 
            elif vehicle in profile:         
                vehicle = vehicle     
                loc1 = input("Ingrese Ciudad Origen: ") 

            if loc1 == "salir" or loc1 == "s": 
                break     
            orig = geocoding(loc1, key) 
            loc2 = input("Ingrese Ciudad Destino: ")   
            ...
            if paths_status == 200:             
                ...
                print("Distancia: {0:.1f} km / {1:.1f} millas".format(km, millas)) 
                print("Duración: {0:02d}:{1:02d}:{2:02d}".format(hr, min, sec))            
                print("---------------------------------------")  
